...
enum GUITestData {
    ...
    static var sampleFolders: [MailFolder] {
        [
            MailFolder(id: "INBOX", name: "Inbox", totalCount: 10, unreadCount: 10, role: .inbox),
            MailFolder(id: "[Gmail]/Sent Mail", name: "Sent", totalCount: 5, unreadCount: 0, role: .sent),
            MailFolder(id: "[Gmail]/Drafts", name: "Drafts", totalCount: 2, unreadCount: 2, role: .drafts),
